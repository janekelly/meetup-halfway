...
/***/ function(module, exports, __webpack_require__) {
	...
	var _postcodeReducer = __webpack_require__(180);

	var _postcodeReducer2 = _interopRequireDefault(_postcodeReducer);

	var _midpointReducer = __webpack_require__(181);

	var _midpointReducer2 = _interopRequireDefault(_midpointReducer);

	var _listingsReducer = __webpack_require__(182);

	var _listingsReducer2 = _interopRequireDefault(_listingsReducer);

	var _queryReducer = __webpack_require__(184);
	...
	var app = (0, _redux.combineReducers)({
		postcode: _postcodeReducer2.default, midpoint: _midpointReducer2.default, query: _queryReducer2.default, listings: _listingsReducer2.default
	});
	...
	_reactDom2.default.render(_react2.default.createElement(
		...
		{ store: (0, _redux.createStore)(app, initialState, window.devToolsExtension ? window.devToolsExtension() : function (f) {
				return f;
			}) },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isHostObject = __webpack_require__(175),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _listingReducer = __webpack_require__(183);
	...
	var listings = function listings() {
		...
		switch (action.type) {
			case 'ADD_LISTING':
				return [].concat(_toConsumableArray(state), [(0, _listingReducer2.default)(undefined, action)]);
			case 'CLEAR_LISTINGS':
				return {
					listings: {}
				};
...
/***/ function(module, exports) {
	...
	var listing = function listing(state, action) {
		switch (action.type) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PostcodeInput = __webpack_require__(186);

	var _PostcodeInput2 = _interopRequireDefault(_PostcodeInput);

	var _QueryInput = __webpack_require__(208);

	var _QueryInput2 = _interopRequireDefault(_QueryInput);

	var _ButtonWrapper = __webpack_require__(210);

	var _ButtonWrapper2 = _interopRequireDefault(_ButtonWrapper);

	var _ListingsWrapper = __webpack_require__(217);

	var _ListingsWrapper2 = _interopRequireDefault(_ListingsWrapper);
	...
	var App = function App() {
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				'h4',
				null,
				'Let\'s Meetup Halfway...'
			),
			_react2.default.createElement(
				'div',
				{ className: 'form-group' },
				_react2.default.createElement(_PostcodeInput2.default, { name: 'firstinput', displayName: 'Enter the First Postcode' })
			),
			_react2.default.createElement(
				'div',
				{ className: 'form-group' },
				_react2.default.createElement(_PostcodeInput2.default, { name: 'secondinput', displayName: 'Enter the Second Postcode' })
			),
			_react2.default.createElement(
				'div',
				{ className: 'form-group' },
				_react2.default.createElement(_QueryInput2.default, { name: 'query', displayName: 'What would you like to consume?' })
			),
			...
			_react2.default.createElement(_ListingsWrapper2.default, null)
		);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _validatePostcode = __webpack_require__(204);

	var _validatePostcode2 = _interopRequireDefault(_validatePostcode);

	var _createGeocodeUrl = __webpack_require__(205);

	var _createGeocodeUrl2 = _interopRequireDefault(_createGeocodeUrl);

	var _updatePostcode = __webpack_require__(207);

	var _updatePostcode2 = _interopRequireDefault(_updatePostcode);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var PostcodeInput = function PostcodeInput(_ref) {
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement('input', { id: name, ref: function ref(node) {
					input = node;
				},
				onChange: function onChange() {
					if ((0, _validatePostcode2.default)(input.value)) {
						_axios2.default.get((0, _createGeocodeUrl2.default)(input.value)).then(function (result) {
							var data = result.data.results[0].geometry.location;
							dispatch((0, _updatePostcode2.default)(input.value, name, (0, _validatePostcode2.default)(input.value), data.lat, data.lng));
						});
					} else {
						dispatch((0, _updatePostcode2.default)(input.value, name, false, ''));
					}
				} })
		);
	};

	PostcodeInput = (0, _reactRedux.connect)()(PostcodeInput); // dispatch is injected automatically

	exports.default = PostcodeInput;
...
/***/ function(module, exports) {
	...
	var validatePostcode = function validatePostcode(postcode) {
	    ...
	    var regex = new RegExp('^(([gG][iI][rR] {0,}0[aA]{2})|((([a-pr-uwyzA-PR-UWYZ][a-hk-yA-HK-Y]?[0-9][0-9]?)|(([a-pr-uwyzA-PR-UWYZ][0-9][a-hjkstuwA-HJKSTUW])|([a-pr-uwyzA-PR-UWYZ][a-hk-yA-HK-Y][0-9][abehmnprv-yABEHMNPRV-Y]))) {0,}[0-9][abd-hjlnp-uw-zABD-HJLNP-UW-Z]{2}))$');
	    return regex.test(postcode);
	};

	exports.default = validatePostcode;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _uriEncode = __webpack_require__(206);

	var _uriEncode2 = _interopRequireDefault(_uriEncode);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var createGeocodeUrl = function createGeocodeUrl(postcode) {
	       return 'https://maps.googleapis.com/maps/api/geocode/json?address=' + (0, _uriEncode2.default)(postcode) + '&sensor=false&‌​components=country:UK';
	};

	exports.default = createGeocodeUrl;
...
/***/ function(module, exports) {
	...
	var uriEncode = function uriEncode(postcode) {
		return window.encodeURIComponent(postcode);
	};

	exports.default = uriEncode;
...
/***/ function(module, exports) {
	...
	var updatePostcode = function updatePostcode(postcode, name, isValid, lat, lng) {
	...
	exports.default = updatePostcode;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _updateQuery = __webpack_require__(209);
	...
	var QueryInput = function QueryInput(_ref) {
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement('input', { id: name, ref: function ref(node) {
				...
				onChange: function onChange() {
					dispatch((0, _updateQuery2.default)(input.value));
				}
			})
		);
	};

	QueryInput = (0, _reactRedux.connect)()(QueryInput); // dispatch is injected automatically
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ButtonWrapper = (0, _reactRedux.connect)(mapStateToProps)(_Button2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _updateMidpoint = __webpack_require__(212);

	var _updateMidpoint2 = _interopRequireDefault(_updateMidpoint);

	var _addListing = __webpack_require__(213);

	var _addListing2 = _interopRequireDefault(_addListing);

	var _clearListings = __webpack_require__(214);

	var _clearListings2 = _interopRequireDefault(_clearListings);

	var _createMidpointUrl = __webpack_require__(215);

	var _createMidpointUrl2 = _interopRequireDefault(_createMidpointUrl);

	var _createListingUrl = __webpack_require__(216);

	var _createListingUrl2 = _interopRequireDefault(_createListingUrl);
	...
	var Button = function Button(_ref) {
		...
		var midpointLat = _ref.midpointLat;
		var midpointLng = _ref.midpointLng;
		var dispatch = _ref.dispatch;
		...
		return _react2.default.createElement(
			...
			{ onClick: function onClick(e) {
					...
					if (valid) {
						dispatch((0, _clearListings2.default)());
						var url = (0, _createMidpointUrl2.default)(lat1, lng1, lat2, lng2);
						_axios2.default.get(url).then(function (result) {
							var points = result.data.trips[0].via_points;

							var midpoint = points[Math.ceil(points.length / 2)];
							dispatch((0, _updateMidpoint2.default)(midpoint));
						}).then(function () {
							if (midpointLat !== 0 || midpointLng !== 0) {
								var _url = (0, _createListingUrl2.default)(midpointLat, midpointLng, query);

								_axios2.default.get(_url).then(function (result) {
									if (result.status === 200) {
										var venues = result.data.response.venues;

										venues.map(function (venue) {
											dispatch((0, _addListing2.default)(venue.name, venue.specials, venue.location.formattedAddress));
										});
									}
								});
							}
...
/***/ function(module, exports) {
	...
	var updateMidpoint = function updateMidpoint(midpoint) {
		return {
			type: 'UPDATE_MIDPOINT',
			coordinates: midpoint
		};
	};

	exports.default = updateMidpoint;
...
/***/ function(module, exports) {
	...
	var listingId = 0;
	var addListing = function addListing(name, specials, address) {
		return {
			type: 'ADD_LISTING',
			name: name,
			specials: specials,
...
/***/ function(module, exports) {
	...
	var createMidpointUrl = function createMidpointUrl(lat1, lng1, lat2, lng2) {
		return 'http://router.project-osrm.org/trip?loc=' + lat1 + ',' + lng1 + '&loc=' + lat2 + ',' + lng2;
	};

	exports.default = createMidpointUrl;
...
/***/ function(module, exports) {
	...
	var createListingUrl = function createListingUrl(lat, lng, query) {
	...
	exports.default = createListingUrl;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Listings = __webpack_require__(218);
	...
	var ListingsWrapper = (0, _reactRedux.connect)(mapStateToProps)(_Listings2.default);

	exports.default = ListingsWrapper;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Listing = __webpack_require__(219);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ListingName = __webpack_require__(220);

	var _ListingName2 = _interopRequireDefault(_ListingName);

	var _ListingAddy = __webpack_require__(221);

	var _ListingAddy2 = _interopRequireDefault(_ListingAddy);
	...
	var Listing = function Listing(_ref) {
		...
		var address3 = _ref.address3;
		var address4 = _ref.address4;

		return _react2.default.createElement(
			'div',
			{ className: 'listing', key: key },
			_react2.default.createElement(_ListingName2.default, { name: name }),
			_react2.default.createElement(_ListingAddy2.default, { address1: address1, address2: address2, address3: address3, address4: address4 })
		);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ListingName = function ListingName(_ref) {
		var name = _ref.name;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ListingAddy = function ListingAddy(_ref) {
		var address1 = _ref.address1;
		var address2 = _ref.address2;
		var address3 = _ref.address3;
		var address4 = _ref.address4;
